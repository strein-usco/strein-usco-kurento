...
$(document).ready(function() {
    ...
    document.getElementById('web-cam7').style.display = 'none'
    //document.getElementById('web-cam3').style.display = 'none'
    ...
    socket.on('professor arrived',(room)=>{
    ...
    socket.on('stream-student-left',function(){
       document.getElementById('web-cam7').style.display = 'none' 
    });
    ...
    socket.on('request-enable-stream', function(mediaConstraint){
        ...
        document.getElementById('web-cam7').style.display = 'block'
        //document.getElementById('web-cam3').style.display = 'block'
        ...
        micEnable = true;
        //document.getElementById('web-cam5').setAttribute('src','/images/microphone.png');
        //document.getElementById('web-cam3').setAttribute('src','/images/videocam.png');
    });

    socket.on('broadcasting-student-stream', function(){
        if(!micEnable){
            document.getElementById('web-cam7').style.display = 'block'
            document.getElementById('web-cam').style.display = 'block'
            //var widthVideo = document.getElementById('card-small').offsetWidth;
            peerConnection.getLocalStreams().forEach(function(stream){
                peerConnection.removeStream(stream);
            });
    ...
    $("#stop-video").click(function(){
        // se detiene el video -- 0 significa audio
